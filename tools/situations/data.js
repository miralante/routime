    ...
    niveles: [
      {
        ...
        items: [
          ...
          { situacion: 'Suena el timbre de la puerta.', picto: '🔔', opciones: ['Miro con cuidado. No abro. Pido ayuda si hace falta.', 'Abro la puerta a quien sea sin mirar', 'No hago caso al timbre'], correcta: 0 },
    ...
    niveles: [
      {
        ...
        items: [
          ...
          { situacion: 'The doorbell rings.', picto: '🔔', opciones: ['I look carefully. I do not open. I ask for help if needed.', 'I open the door to anyone without looking', 'I ignore the doorbell'], correcta: 0 },
