...
(function () {
  ...
  App.i18n.register({
    ...
    "rightsP2": 'To view or delete it, go to Settings:',
    "rightsItem1Label": 'Reset the person’s data',
    "rightsItem1Text": 'erases the chosen language, the name and the contact details, while keeping progress.',
    "rightsItem2Label": 'Reset the entire application',
    "rightsItem2Text": 'erases absolutely everything, as if it had just been installed.',
    ...
    "contactP2": 'Last updated: 22 July 2026.',
    ...
    "footerTeamGuide": 'Support team guide'
  }, 'en');
})();
