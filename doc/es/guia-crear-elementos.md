...
| **Entrenamiento de habilidad pura** | El objetivo terapéutico **es** la habilidad (memoria secuencial, motricidad fina, lógica, puzzles, percepción). El estímulo ya es el contexto: el piano, la cuadrícula, las piezas, la secuencia. | `piano-keys`, `tracing`, `fit`, `pairs`, `connect-dots` |
