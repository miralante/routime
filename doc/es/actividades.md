...
**Color del módulo:** Naranja

**¿Qué trabaja?** Memoria visual, memoria auditiva, atención, concentración, percepción espacial.

| Actividad | Descripción |
|-----------|-------------|
| **Parejas** | Encuentra las cartas que son iguales |
| **Diferencias** | Encuentra las diferencias entre dos imágenes casi iguales |
| **¿Qué falta?** | Mira una serie de objetos y adivina cuál falta |
| **Ecos** | Repite secuencias de sonidos o colores como Simón dice |
| **Giros y Espejos** | Identifica figuras giradas o reflejadas |
| **Los Bloques** | Copia un modelo de construcción en una cuadrícula |
| **¿Dónde está?** | Toca el objeto que está a la izquierda, derecha, encima o debajo |
| **El Camino** | Lleva un personaje desde el inicio hasta la meta con flechas |
| **Encaja la Pieza** | Coloca las piezas en su sitio como en el Tetris |
| **El Teatro** | Pon los personajes donde indican las órdenes (delante, detrás) |
...
**¿Qué trabaja?** Vocabulario, comprensión, lenguaje figurado, escritura.
