...
| **Pure-skill training** | The therapeutic goal **is** the skill (sequential memory, fine motor, logic, puzzles, perception). The stimulus is already the context: the piano, the grid, the pieces, the sequence. | `piano-keys`, `tracing`, `fit`, `pairs`, `connect-dots` |
